...
<head>
	<meta charset='UTF-8'>
	<link rel="shortcut icon" href="twh.png">
...
<body onload='window.print()' style="font-size: 12px;margin-top:0;position:absolute;">
	<div style="width: 925px; height: 267px; margin-bottom:10px; background-image: url('<?= base_url('asset/kartu/desain/') . $sekolah['desain']; ?>');">
		...
		<p style="margin-top:10px;margin-bottom:-5px; padding-left: 570px; color:white; font-family:monospace;font-size: 16px;text-align: right; padding-right: 20px"><strong>TATA TERTIB SEKOLAH</strong><br>
			<div style=" list-style-position: inside; padding-left: 550px; color:white;  font-family:arial, serif;font-size: 12px;text-align: right; padding-right: 20px">
				<p>- Disiplin, dan tepat waktu <br>
					- Taat dan hormat<br> kepada semua Guru
					dan <br>karyawan SMK Ma'arif NU 01 Wanasari <br>
					- Mena'ati Peraturan di SMK Ma'arif NU 01 Wanasri <br>
					- Selalu menjaga nama baik SMK Ma'arif NU 01 Wanasari <br>
					- Siswa harus hadir sebelum jam pembelajaran</p>
			</div>
		</p>
